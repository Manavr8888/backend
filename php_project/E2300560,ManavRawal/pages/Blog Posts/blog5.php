...
<head>
    <style>
        .bg-section {
            background-image: url(../../images/forblog5.jpg);
...
<body class="bg-section">
    ...
    <br>
    <div class="head">
        <h1>Environmental Impact of Bonsai</h1>
    </div>
    <div class="container">
        <h4>
        ...
        <br>
        <br>
        <p>The impact of bonsai on the environment is a mixed issue. On one hand, bonsai can have a positive impact as it promotes the conservation of endangered species and helps preserve their gene pool. Bonsai trees are also often grown in pots, which means they take up less space and have a smaller carbon footprint compared to larger trees.</p>
        <br>
        <p>However, the production and import of bonsai trees can have negative impacts on the environment. Many bonsai trees are imported from other countries, contributing to the destruction of natural habitats and the loss of biodiversity. Additionally, the use of fertilizers, pesticides, and other chemicals can harm the environment and disrupt ecosystems.</p>
        <br>
        <p>It is important to consider the environmental impact of bonsai when practicing this art form. Choose species that are native to your area and minimize the use of chemicals and other harmful substances. By being mindful of the impact of bonsai on the environment, practitioners can help protect the natural world and promote sustainable bonsai practices.</p>
    </div>
    <hr>
        <div class="footer"> 
